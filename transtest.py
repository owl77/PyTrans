...
Dic = Dictionary(P,PP)
Dic.dictionary = {("noun","cat"):"gato", ("noun","table"):"mesa", ("article","the"):"", ("indarticle",""):"", ("pronoun",""):"",("verb1","love"):"am",("verb0","run"):"corr"}
Dic.word = {"noun":Pnoun, "pronoun":Ppronoun, "article":Particle, "indarticle": PIarticle, "verb0": Pverb0, "verb1":Pverb1}
